...
\begin{figure}[hp]
\centering
     \includegraphics[width=\textwidth]{pre work/1st day Cognos - processed/select package for Report Studio.jpg}
...
\begin{figure}[hp]
\centering
     \includegraphics[width=\textwidth]{pre work/1st day Cognos - processed/report studio welcome page.jpg}
...
\begin{figure}[hp]
\centering
     \includegraphics[width=\textwidth]{pre work/1st day Cognos - processed/select template.jpg}
...
\begin{figure}[hp]
\centering
     \includegraphics[width=\textwidth]{pre work/1st day Cognos - processed/blank template, mosaic data loaded.jpg}
...
\begin{figure}[hp]
\centering
     \includegraphics[height=\textheight]{Define_phase_people.png}
      \caption{CEC employees involved in the project.}
       \label{normal_case}
\end{figure}
...
\begin{figure}[hp]
\centering
     \includegraphics[width=\textwidth]{Report 1/report 1, query 4.jpg}
...
\begin{center}
  ...
  \captionof{figure}{Report 3, Query 1 (up to 3 interactions)}
  \label{normal_case}
\end{center}
...
\begin{center}
  ...
  \captionof{figure}{Report 3, Query 1 (above 3 interactions)}
  \label{normal_case}
\end{center}
